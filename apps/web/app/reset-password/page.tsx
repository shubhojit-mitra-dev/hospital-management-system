    ...
    <div className="flex items-center justify-center min-h-screen p-6">
      <div className="relative w-full max-w-md p-8 rounded-2xl bg-slate-900/45 backdrop-blur-xl border border-white/8 shadow-2xl overflow-hidden before:content-[''] before:absolute before:-top-1/2 before:-left-1/2 before:w-[200%] before:height-[200%] before:bg-[radial-gradient(circle,rgba(139,92,246,0.08)_0%,transparent_60%)] before:pointer-events-none">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-400">Enter the OTP sent to your email and your new password</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium mb-2 text-slate-200" htmlFor="newPassword">
              New Password
            </label>
            <input
              id="newPassword"
              type="password"
              className={`w-full px-4 py-3 text-sm rounded-lg bg-slate-950/50 border ${errors.newPassword ? 'border-red-400' : 'border-white/10'} text-white outline-none transition focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20`}
              placeholder="••••••••"
